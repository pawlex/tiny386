/* First bare-metal RV32 milestone: run the i386 core on RISC-V and
 * verify it executes. CPU_CB stubs print only -- nothing is routed
 * anywhere, because the peripheral and memory paths are undefined. */
#include <stdio.h>
#include <string.h>
#include "i386.h"
#include "test386.h"
